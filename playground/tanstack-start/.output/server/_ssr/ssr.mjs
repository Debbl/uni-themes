...
import { a as RouterProvider, m as require_react, n as defineHandlerCallback, p as require_jsx_runtime, t as renderRouterToStream } from "../_libs/@tanstack/react-router+[...].mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BCVJoawd.mjs");
...
var manifest = { "aa1b1adc77303d87dc48fee1e98c665be092cc2ae375fcf3ecdaf73a3c0396a9": {
	functionName: "getServerTheme_createServerFn_handler",
	importer: () => import("../__root-ByoM-hfj.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-CmN_xlxE.mjs").then((n) => n.t),
		import("./start-Bf9fHYeT.mjs"),
		import("./empty-plugin-adapters-Cbd67-Xo.mjs")
	]);
	return {
		routerEntry,
		startEntry,
